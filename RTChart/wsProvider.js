angular
      ...
      .provider(
            ...
            function wsClientProvider() {
	            ...
	            // This creates a new subscriberID for a subscriber
	            ...
	            var _getSubscribeId = function(subscriberId, prefix) {
	                  ...
	                  function wsFactory($websocket, $cookies, $q, $rootScope) {
		                  ...
		                  var subscriberHandler = function(data) {
			                  ...
			                  if (subscriberId
				                  ...
				                  subscribersRegistry[subscriberId].cb(data.result)
			                  } else {
				                  console
		                  ...
		                  var methods = {
		                     ...
		                     subscribe : function(prefix, callback) {
			                     if (_subscribeChannel) {
				                     ...
				                     //var id = _getSubscribeId(subscriberId, prefix);
